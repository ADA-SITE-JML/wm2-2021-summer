insert into PROFILES(full_name, username, password, image, bio) values ('Admin user', 'admin', 'admin', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfrLAZZRhW85ny1UWBbuyo4_ATKJgx7dHK6Q&usqp=CAU', 'my bio');
insert into PROFILES(full_name, username, password, image, bio) values ('Fagan Rasulov', 'frasulov4671', 'fagan123', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOd256TcC6vcaQ99TYzoP0pBbch9_Q-bbrmw&usqp=CAU', 'lorem text');
insert into PROFILES(full_name, username, password, image) values ('Jamal Haciyev', 'jhaciyev', 'fagan123', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRC8kiSH5ZSAcVoj3tAQQDoP_ux0sSricMyUg&usqp=CAU');
insert into PROFILES(full_name, username, password, image) values ('Rewad Necefli', 'rnecefli', 'fagan123','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRC8kiSH5ZSAcVoj3tAQQDoP_ux0sSricMyUg&usqp=CAU');
